...
import { FaShoppingCart, FaPlus, FaArrowLeft, FaClock, FaMapMarkerAlt, FaPhone, FaPizzaSlice } from 'react-icons/fa';
      ...
      <div className="pt-20 md:pt-24 pb-12">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {pizzaMenu.map((pizza) => (
              <div key={pizza.id} className="bg-gradient-to-br from-pizza-yellow/10 to-transparent border border-pizza-yellow/30 rounded-2xl overflow-hidden hover:border-pizza-yellow transition-all transform hover:scale-105">
                ...
                <div className="p-4">
                  ...
                  <p className="text-gray-400 text-sm mb-4">{pizza.desc}</p>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {Object.entries(pizza.sizes).map(([size, price]) => (
                        <button
                          key={size}
                          onClick={() => setSelectedSize({ ...selectedSize, [pizza.id]: size })}
                          className={`py-2 px-3 rounded-lg border text-sm font-semibold transition-all ${
                            selectedSize[pizza.id] === size
